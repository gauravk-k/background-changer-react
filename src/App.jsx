...
function App() {
  ...
  return (
    <>
      ...
      >
        <div className="h-screen fixed flex flex-wrap justify-center items-center inset-x-0 px-2">
          <div className="flex flex-wrap justify-center mx-auto gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
